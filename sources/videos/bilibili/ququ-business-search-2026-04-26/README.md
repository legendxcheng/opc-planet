...
- 搜索结果处理范围：第 1 页到第 50 页中的已成功请求页面；部分页面被 B 站 412 风控拦截。
- 已下载字幕文本：122 个 `.txt` 文件，其中第一页 15 个，后续批次 107 个。
...
| `BV1idcbzhEw5` | 曲曲：我的商业头脑严重被低估了！连麦拆解为何你的产品无人买？ | `data/raw/bilibili/subtitles/ququ-business-search-2026-04-26/BV1idcbzhEw5-ai-zh.txt` |
| `BV1y9ogBLETW` | 曲曲 销售要选择天花板高的行业 | `data/raw/bilibili/subtitles/ququ-business-search-2026-04-26/BV1y9ogBLETW-ai-zh.txt` |
| `BV173PPzKEsB` | 曲曲：现金流生意一定要会算 ROI | `data/raw/bilibili/subtitles/ququ-business-search-2026-04-26/BV173PPzKEsB-ai-zh.txt` |
| `BV1ukF7zmENK` | 曲曲讲商业，全程干货：AI产品没人用，你的流量不是冲着产品来的 | `data/raw/bilibili/subtitles/ququ-business-search-2026-04-26/BV1ukF7zmENK-ai-zh.txt` |
| `BV1mp6KBAEZZ` | 曲曲分享事业经：找到产品的卖点才是销售的关键 | `data/raw/bilibili/subtitles/ququ-business-search-2026-04-26/BV1mp6KBAEZZ-ai-zh.txt` |
| `BV1xM48zCEyP` | 想创业，首先商业逻辑要闭环 | `data/raw/bilibili/subtitles/ququ-business-search-2026-04-26/BV1xM48zCEyP-ai-zh.txt` |
